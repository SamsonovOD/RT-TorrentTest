...
def add():
	...
	console = subprocess.check_output('CD C:/Program Files/Transmission & transmission-remote -a ' + link + ' -w C:/nul', shell=True)
	os.system('cls')
...
def test():
	os.system('cls')
	print("Test2")
	input_path = 'C:/Users/RT-Admin/Desktop/torrentin/'
	output_path = 'C:/Users/RT-Admin/Desktop/torrentout'
	torrents = []
	for r, d, f in os.walk(input_path):
		for file in f:
			if '.torrent' in file:
				torrents.append(os.path.join(r, file))
	console = subprocess.check_output('CD C:/Program Files/Transmission & transmission-remote -t all --remove-and-delete', shell=True)
	for i in torrents:
		st = 'CD C:/Program Files/Transmission & transmission-remote -a ' + i + ' -w '+output_path
		print(st)
	...
	console = subprocess.check_output('CD C:/Program Files/Transmission & transmission-remote --torrent all --stop', shell=True)
	menu_actions['main_menu']()
	return
